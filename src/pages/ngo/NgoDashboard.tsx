...
const NgoDashboard = () => {
  ...
  useEffect(() => {
    ...
    // ✅ Auth listener for session expiry/logout
  ...
  // PROFILE + NGO LOADER
  // ---------------------------
  const loadProfileAndData = async (userId: string) => {
    try {
      ...
      if (profile.role !== "ngo") {
        toast({
          variant: "destructive",
          title: "Access denied",
          description: "This area is for NGO accounts only.",
        });
  ...
  const handleAcceptDonation = async (donationId: string) => {
    ...
    if (error) {
      ...
      if (ngoData) await fetchDonations(ngoData.id);
    }
  };
          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                ...
                You’ll receive a notification once your NGO is approved and you can start accepting donations.
              </AlertDescription>
            </Alert>
                ...
                <Card key={donation.id} className="shadow-card">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Contact: {donation.profiles?.phone}
                      </p>
